...
def main():
	...
	parser.add_argument('--model_path', type=str, default='/media/ssd_working_space/osaid/Data/Models/latest_model_face_temp.ckpt',
	...
	parser.add_argument('--caption_thought_vectors', type=str, default='/media/ssd_working_space/osaid/Data/sample_caption_vectors.hdf5',
	...
	test_encoding = pickle.load(open('/media/ssd_working_space/osaid/celebA/train/encoding','rb'))
	image_name 		= [key for key in test_encoding.keys()]
	caption_vectors = [test_encoding[key].reshape(-1) for key in test_encoding.keys()]
	caption_image_dic = {}
	...
	for cn in range(0, len(caption_vectors)):
		...
		scipy.misc.imsave( '/media/ssd_working_space/osaid/Data/infered_train_images/'+image_name[cn] , caption_image_dic[ cn ][0])
